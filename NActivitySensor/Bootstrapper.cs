namespace NActivitySensor
{
    ...
    public class Bootstrapper : IDisposable
    {
        ...
        public Bootstrapper(object application, object addIn, ILogger logger, Configuration configuration)
        {
            ...
            // Reporters
            Builder.RegisterType<MSSqlReporter>().As<IReporter>().WithMetadata("MSSqlReporter", new object()).SingleInstance();
            Builder.RegisterType<OutputWindowReporter>().As<IReporter>().WithMetadata("OutputWindowReporter", new object()).PreserveExistingDefaults().SingleInstance();
